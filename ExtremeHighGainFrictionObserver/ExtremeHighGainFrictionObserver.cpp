#include "ExtremeHighGainFrictionObserver.h"

template<typename ROBOT>
void ExtremeHighGainFrictionObserver<ROBOT>::initialize(ROBOT &robot, double delt)
{
...
template<typename ROBOT>
void ExtremeHighGainFrictionObserver<ROBOT>::reset(ROBOT& robot)
{
    /**< Reset the integral terms in the H-inifinity control algorithm */
    robot.resetHinfController();
...
template<typename ROBOT>
void ExtremeHighGainFrictionObserver<ROBOT>::compute(ROBOT &robot, const LieGroup::Vector3D &gravDir,
...
template<typename ROBOT>
typename ExtremeHighGainFrictionObserver<ROBOT>::JointVec
ExtremeHighGainFrictionObserver<ROBOT>::friction_observer_L1_PD(ROBOT &robot, const LieGroup::Vector3D &gravDir, const JointVec &Control_input,  const MotionData &motionData, ControlData &controlData)  
{
...
POCO_BEGIN_MANIFEST(NRMKControl::ControlAlgorithmCreator)
        POCO_EXPORT_CLASS(ExtremeHighGainFrictionObserverCreator)
POCO_END_MANIFEST
