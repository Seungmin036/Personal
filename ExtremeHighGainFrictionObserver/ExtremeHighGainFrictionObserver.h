...
class ExtremeHighGainFrictionObserver : public NRMKControl::ControlAlgorithm<ROBOT>
{
...
public:
    ...
    ExtremeHighGainFrictionObserver() = default;
...
class ExtremeHighGainFrictionObserverCreator : public NRMKControl::ControlAlgorithmCreator
{
CONTROL_CREATOR_BODY(ExtremeHighGainFrictionObserver)
};