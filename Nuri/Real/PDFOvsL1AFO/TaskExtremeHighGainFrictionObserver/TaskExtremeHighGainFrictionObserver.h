...
class TaskExtremeHighGainFrictionObserver : public NRMKControl::ControlAlgorithm<ROBOT>
{
...
public:
    ...
    TaskExtremeHighGainFrictionObserver() = default;
    ...
    Eigen::Vector3d computeQuinticSpline(const Eigen::Vector3d& p0, const Eigen::Vector3d& pf, const Eigen::Vector3d& v0, const Eigen::Vector3d& vf,
                                             const Eigen::Vector3d& a0, const Eigen::Vector3d& af, double t, double T);
    Eigen::Vector3d computeQuinticSplineVelocity(const Eigen::Vector3d& p0, const Eigen::Vector3d& pf,
...
class TaskExtremeHighGainFrictionObserverCreator : public NRMKControl::ControlAlgorithmCreator
{
CONTROL_CREATOR_BODY(TaskExtremeHighGainFrictionObserver)
};