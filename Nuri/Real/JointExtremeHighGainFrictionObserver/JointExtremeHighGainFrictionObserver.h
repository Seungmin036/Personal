...
class JointExtremeHighGainFrictionObserver : public NRMKControl::ControlAlgorithm<ROBOT>
{
...
public:
    ...
    JointExtremeHighGainFrictionObserver() = default;
    ...
    UDP_client<std::string> udp_{9870, "192.168.151.81"};
    void sendStateUDP(ROBOT &robot);
...
class JointExtremeHighGainFrictionObserverCreator : public NRMKControl::ControlAlgorithmCreator
{
CONTROL_CREATOR_BODY(JointExtremeHighGainFrictionObserver)
};