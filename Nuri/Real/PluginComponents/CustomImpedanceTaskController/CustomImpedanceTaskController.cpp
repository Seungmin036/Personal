...
#include "CustomImpedanceTaskController.h"

template<typename ROBOT>
void CustomImpedanceTaskController<ROBOT>::initialize(ROBOT &robot, double delt)
{
...
template<typename ROBOT>
void CustomImpedanceTaskController<ROBOT>::reset(ROBOT &robot)
{
...
template<typename ROBOT>
void CustomImpedanceTaskController<ROBOT>::compute(ROBOT &robot, const LieGroup::Vector3D &gravDir,
                                             const MotionData &motionData, ControlData &controlData)
{
    ...
    _robotNominal->computeTaskErr(_tposNom, _tvelNom, posDesired, velDesired, e, edot);

    tauImp = _kp.cwiseProduct(Jinv*e) - _kv.cwiseProduct(_robotNominal->qdot());
...
template<typename ROBOT>
void CustomImpedanceTaskController<ROBOT>::initializeNominalRobot(ROBOT & robot)
{
...
template<typename ROBOT>
void CustomImpedanceTaskController<ROBOT>::_readFTsensor(ROBOT & robot, ExtendedForce& extForce)
{
