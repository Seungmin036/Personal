...
class CustomImpedanceTaskController : public NRMKControl::ControlAlgorithm<ROBOT>
{
...
public:
    ...
    CustomImpedanceTaskController() = default;
...
class CustomImpedanceTaskControllerCreator : public NRMKControl::ControlAlgorithmCreator
{
CONTROL_CREATOR_BODY(CustomImpedanceTaskController)
};
