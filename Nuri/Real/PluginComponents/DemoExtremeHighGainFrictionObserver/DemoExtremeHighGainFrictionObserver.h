...
class DemoExtremeHighGainFrictionObserver : public NRMKControl::ControlAlgorithm<ROBOT>
{
...
public:
    ...
    DemoExtremeHighGainFrictionObserver() = default;
    ...
    JointVec dot_fixed_PD(ROBOT &robot, const LieGroup::Vector3D& gravDir, const MotionData &motionData, ControlData &controlData);
    JointVec line_fixed_PD(ROBOT &robot, const LieGroup::Vector3D& gravDir, const MotionData &motionData, ControlData &controlData);
    JointVec released_PD(ROBOT &robot, const LieGroup::Vector3D& gravDir, const MotionData &motionData, ControlData &controlData);
    JointVec total_fixed_PD(ROBOT &robot, const LieGroup::Vector3D& gravDir, const MotionData &motionData, ControlData &controlData);
    void state_transition(ROBOT &robot, const LieGroup::Vector3D& gravDir, const MotionData &motionData, ControlData &controlData);
...
private:
    ...
    Eigen::MatrixXd Kp_task_, Kd_task_;
    ...
    // std::unique_ptr<ROBOT> robotNominal_;
...
class DemoExtremeHighGainFrictionObserverCreator : public NRMKControl::ControlAlgorithmCreator
{
CONTROL_CREATOR_BODY(DemoExtremeHighGainFrictionObserver)
};