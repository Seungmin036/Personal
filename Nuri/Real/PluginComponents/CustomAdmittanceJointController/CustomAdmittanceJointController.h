...
class CustomAdmittanceJointController : public NRMKControl::ControlAlgorithm<ROBOT>
{
...
public:
    ...
    CustomAdmittanceJointController() = default;
...
class CustomAdmittanceJointControllerCreator : public NRMKControl::ControlAlgorithmCreator
{
CONTROL_CREATOR_BODY(CustomAdmittanceJointController)
};
